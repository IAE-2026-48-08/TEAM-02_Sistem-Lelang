...
return [
    ...
    'defaults' => [
        ...
        'scanOptions' => [
             ...
             */
            'generator_factory' => \App\Swagger\CustomGenerator::class,
             ...
             *
             * We use ReflectionAnalyser with both attribute and PHPDoc factories
             * so existing @OA\Info / @OA\Get annotations are detected by L5-Swagger.
             *
             * @see \OpenApi\scan
             */
